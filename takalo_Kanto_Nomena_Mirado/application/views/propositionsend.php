...
<h2>Send</h2>
	<?php
	if($propositionsend!=null){
		for($i=0;$i<count($propositionsend);$i++){?>
			<p>proposition le <?php echo $propositionsend[$i]['datedemande']; ?> <a href="todetailsend?idechange=<?php echo $propositionsend[$i]['idechange']; ?>"> voir detail </a></p>
		<?php
		}
	}else{ ?>
