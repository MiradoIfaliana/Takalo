...
<div id="container">
	...
	<?php
		...
		<a href="accepter?idechange=<?php echo $idechange; ?>&iduserdestinataire=<?php echo $objetreceive[0]['iduser']; ?>">accepter</a>
		<a href="refuser?idechange=<?php echo $idechange; ?>">refuser</a>
		<?php } ?>
