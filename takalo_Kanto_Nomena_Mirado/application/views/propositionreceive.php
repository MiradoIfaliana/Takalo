...
<div id="container">
	<h1>Bienvenu <?php echo $_SESSION['connected']['nom']; ?></h1>
</div>
<h2>Receive</h2>
	<?php
	if($propositionreceive!=null){
		for($i=0;$i<count($propositionreceive);$i++){?>
			<p>proposition le <?php echo $propositionreceive[$i]['datedemande']; ?> <a href="todetailreceive?idechange=<?php echo $propositionreceive[$i]['idechange']; ?>"> voir detail </a></p>
		<?php
		}
	}else{ ?>
		<p>aucune proposition envoyer</p>
	<?php
	}
	?>
